...
<div class='container' style='width:50%;  border:1px solid black; max-width:900px; min-width:550px; '>
  ...
  -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: black; text-shadow:2px 0 0 black;">
    ...
    <div class="row">
       ...
       CLIENTE      
        ...
        <div class="col col-lg-10" style='border:1px solid black; padding:0;'>
            <select name='cliente' type="text" class="form-control" id="cliente" required="true" style='height: 37px; font-size: 1.2em'>
                <option> SELECCCIONE CLIENTE</option>
    ...
    <div class="row" >
       ...
       EMAIL      
        ...
        <div class="col col-md-5" style='border:1px solid black; padding: 0;'>
            <select name='mail' type="email" class="form-control" id="cliente" required="true" style='height:30px; padding:0 0 0 15px; font-size: 1.3em;'>
      ...
      <div class="col col-md-2" style="font-size: 1.2em; border:1px solid black;">
        ...
        <div class="col col-md-3" style='border:1px solid black;padding:0;'>
            <select name='contacto' type="number" class="form-control"style='height:30px; font-size: 1.1em; text-align: center;'>
    ...
    <div class="row" >
       ...
       OBRA    
        ...
        <div class="col col-lg-5" style='border:1px solid black;padding:0;'>
            <select name='obra' type="text" class="form-control" id="obra" style='height:30px; font-size: 1.2em; padding:0 0 0 15px;'>
       <option value=''> SELECCCIONE OBRA</option>
    ...
    <div class="row" style='height: 38px;' >
        <div class="container col col-lg-1" style=" height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie1" value="1" type="number" class="form-control" style=" height:36PX; font-size: 1.3em; padding:0 0 0 17px;" >   
        </div>
      ...
      <div class="col col-lg-1" style="height: 38px; border: 1PX solid black ; padding:0;">
          <input name='dia1' value="1" type="number" class="form-control" style=" height: 36px; font-size: 1.3em;padding:0 0 0 17px;">
        </div>
    ...
    <div class="row"  style='height: 38px;'>
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie2" type="number" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style=" height: 38px; border: 1PX solid black; padding:0;" >
      ...
      <div class="col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
          <input name='dia2' type="number"  class="form-control" style="  height: 36px;font-size: 1.3em;padding:0 0 0 17px;">
        </div>
        <div class="col col-lg-3" style="height: 38px; border: 1PX solid black; padding:0;">
    ...
    <div class="row" style='height: 38px;' >
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie3" type="number" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
      ...
      <div class="col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
          <input name='dia3' type="number" class="form-control" style=" height: 36px;font-size: 1.3em; padding:0 0 0 17px;">
        </div>
        <div class="col col-lg-3" style="height: 38px; border: 1PX solid black; padding:0;">
    ...
    <div class="row" style='height: 38px;'  >
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie4" type="number" class="form-control" style=" height: 36px; font-size: 1.2em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
      ...
      <div class="col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
          <input name='dia4' type="number" class="form-control" style="  height: 36px;font-size: 1.3em; padding:0 0 0 17px;">
        </div> 
        <div class="col col-lg-3" style="height: 38px; border: 1PX solid black; padding:0;">
    ...
    <div class="row" style='height: 38px;'>
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie5" type="number" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
      ...
      <div class="col col-lg-1" style=" height: 38px; border: 1PX solid black; padding:0;">
          <input name='dia5' type="number" class="form-control" style="height: 36px; font-size: 1.3em; padding:0 0 0 17px;">
        </div>
        <div class="col col-lg-3" style=" height: 38px; border: 1PX solid black; padding:0;">
  ...
  <!----------------------FILA 6-----------------------> 
        ...
        <div class="col col-lg-1" style=" border: 1PX solid black; padding:0; height:32px;">
            <input name='pie6' value="1" type="number" class="form-control"style='height:30px; font-size: 1.2em; padding:0 0 0 17px;'>
        </div>
      ...
      <div class="col col-lg-1" style=" border: 1PX solid black; padding:0; height:32px;">
        <input name='dia6' value="1" type="number" class="form-control" style='height:30px;font-size: 1.2em; padding:0 0 0 17px; '>
        </div>      
  ...
  <!----------------------FILA TOTALES----------------------->
    ...
    <div style='margin-bottom:5px;'>
        ...
        <button type="button" onclick="window.location='{{Route('Cotizaciones.CreateNvo')}}'" class="btn btn-warning btn-lg" >¿NUEVO CLIENTE</button>
     </div>
  </div>     
