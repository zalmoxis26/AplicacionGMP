@extends("../Cotizaciones.plantilla")
<style>
...
{!!Form::model($cotis, ['method' => 'PATCH' ,  'action' => ['CotizacionesController@update', $cotis->id ] , 'files' => true])!!}
...
<div class='container' style='width:50%;  border:1px  solid black; margin-bottom: 10px; max-width:900px; min-width:550px; '>
    ...
    <div class="row">
        ...
        <div class="col col-lg-9" style='padding:0px'>
            <div class='container' style="height:50px;padding:0 0 10px 0; font-size: 2.3em; border:1px solid black;-webkit-text-fill-color:#008000; 
  -webkit-text-stroke-width: 1px; -webkit-text-stroke-color: black; text-shadow:2px 0 0 black;">
    ...
    <div class="row" style='height:117px;'>
        ...
        <div class="col col-lg-5" style="padding:0;">
            <div class='container' style='height: 50%; border:1px solid black'>
                INICIO DE RENTA <input name="fechaRem" value="{{$cotis->fechaRem}}" type="date" style="font-size:1.2em;text-align:right;">
            </div>
            <div class='container' style='height: 50%; border:1px solid black'>
               TERMINO DE RENTA <input  name="fechaDev" value="{{$cotis->fechaDev}}" type="date" style="font-size:1.2em; text-align:right;">
            </div>    
        </div>   
  </div>
    ...
    <div class="row">
       ...
       CLIENTE      
        ...
        <div class="col col-lg-10" style='border:1px solid black; padding:0;'>
            <select name='cliente' type="text" value="{{$cotis->cliente}}" class="form-control" id="cliente" style='height: 37px; font-size: 1.2em'>
       <option>{{$cotis->cliente}}</option>
    ...
    <div class="row" >
       ...
       EMAIL      
        ...
        <div class="col col-md-5" style='border:1px solid black; padding: 0;'>
            <select name='mail' type="email"  value="{{$cotis->mail}}" class="form-control" id="cliente" required="true" style='height:30px; padding:0 0 0 15px; font-size: 1.3em;'>
      <option>{{$cotis->mail}}</option>
       @foreach($clientes as $cliente)
    ...
    <div class="row" >
       ...
       OBRA    
        ...
        <div class="col col-lg-5" style='border:1px solid black;padding:0;'>
            <select name='obra' value="{{$cotis->obra}}" type="text" class="form-control" id="obra" style='height:30px; font-size: 1.2em; padding:0 0 0 15px;'>
       <option>{{$cotis->obra}}</option>
      ...
      <div class="col col-lg-3" style="font-size: 1.1em;border:1px solid black;">
        ...
        <div class="col col-lg-2" style='border:1px solid black;padding:0;'>
            <input name="dias" value="{{$cotis->dias}}" type="number" class="form-control" style='height:30px; font-size: 1.5em; text-align: center;'>
        </div> 
  </div>
    ...
    <div class="row" style='height: 38px;' >
        <div class="container col col-lg-1" style=" height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie1" value="{{$cotis->pie1}}" type="number" class="form-control" style=" height:36PX; font-size: 1.3em; padding:0 0 0 17px;" >   
        </div>
      ...
      <div class="col col-lg-1" style="height: 38px; border: 1PX solid black ; padding:0;">
          <input name='dia1'  type="number" value="{{$cotis->dia1}}" class="form-control" style=" height: 36px; font-size: 1.3em;padding:0 0 0 12px;">
        </div>
    ...
    <div class="row"  style='height: 38px;'>
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie2" value="{{$cotis->pie2}}" type="number" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style=" height: 38px; border: 1PX solid black; padding:0;" >
    ...
    <div class="row" style='height: 38px;' >
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie3" type="number" value="{{$cotis->pie3}}" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
    ...
    <div class="row" style='height: 38px;'  >
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie4" type="number" value="{{$cotis->pie4}}" class="form-control" style=" height: 36px; font-size: 1.2em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
    ...
    <div class="row" style='height: 38px;'>
        <div class="container col col-lg-1" style="height: 38px; border: 1PX solid black; padding:0;">
            <input name="pie5" type="number" value="{{$cotis->pie5}}" class="form-control" style=" height: 36px; font-size: 1.3em; padding:0 0 0 17px;">   
        </div>
        <div class="col col-lg-5" style="height: 38px; border: 1PX solid black; padding:0;" >
  ...
  <!----------------------FILA 6-----------------------> 
        ...
        <div class="col col-lg-1" style=" border: 1PX solid black; padding:0; height:32px;">
            <input name='pie6' value="{{$cotis->pie6}}" type="number" class="form-control"style='height:30px; font-size: 1.2em; padding:0 0 0 17px;'>
        </div>
