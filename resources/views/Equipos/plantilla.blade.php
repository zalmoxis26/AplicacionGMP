    ...
    <style>
       ...
       nav li:hover{
           ...
           h1{
               ...
               -webkit-text-stroke-color: black; text-shadow:2px 0 0 #2ECC71; 
           }
   ...
   <div class="collapse navbar-collapse" id="navbarCollapse">
    ...
    <div id='titulo'>
      @yield("contenido") 
       ...
       @yield("pie")
      <div  id="barra" class="footer mt-auto fixed-bottom py-3 bg-dark" style="text-align: center; color: white;">    
